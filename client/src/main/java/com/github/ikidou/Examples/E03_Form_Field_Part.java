...
/**
 * FormUrlEncoded/Field/FieldMap/Multipart/Part/PartMap注解
 */
public class E03_Form_Field_Part {
	...
	public static void main(String[] args) {
		...
		PrintUtils.print(testFileUpload3);
	}
}
